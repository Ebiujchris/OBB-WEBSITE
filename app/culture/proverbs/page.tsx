          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '1.25rem', marginBottom: '3.5rem' }}>
            {proverbs.map((p, i) => (
              <div key={i} style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.06)', borderRadius: '1rem', padding: '1.75rem 2rem', display: 'flex', gap: '1.5rem', alignItems: 'flex-start' }}>
                <span style={{ fontSize: '1.5rem', color: '#C99A2E', fontFamily: 'serif', lineHeight: 1, flexShrink: 0, marginTop: '0.15rem' }}>&ldquo;</span>
                <div>
                  <p className="heading-serif" style={{ fontSize: '1.0625rem', fontStyle: 'italic', color: '#242424', lineHeight: 1.55, marginBottom: '0.75rem' }}>{p.text}</p>
