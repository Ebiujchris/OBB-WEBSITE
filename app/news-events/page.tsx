...
const news = [
  { id: 1, title: 'Cultural Festival Celebration',             date: 'Aug 8, 2026',  excerpt: 'The annual Bwamba cultural festival brought together communities to celebrate our heritage with music, dance and traditional ceremonies.', category: 'Events',    gradient: 'linear-gradient(135deg,#6B1E2E,#242424)' },
  { id: 2, title: 'New Language Documentation Initiative',     date: 'Aug 5, 2026',  excerpt: 'Obudhingiya Bwa Bwamba launches a comprehensive documentation project for Lubwisi, Kwamba and Vonoma languages.',                      category: 'Language',  gradient: 'linear-gradient(135deg,#1F4D3A,#242424)' },
  { id: 3, title: 'Elder Stories Project Completed',           date: 'Jul 30, 2026', excerpt: 'After two years of dedicated work, we have successfully recorded 150 traditional stories from community elders.',                         category: 'Culture',   gradient: 'linear-gradient(135deg,#7A5C3E,#242424)' },
];
        ...
        <div className="container-site">
          ...
          <div style={{ marginBottom: '4.5rem' }}>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem', marginBottom: '2.5rem' }}>
              <h2 className="heading-serif" style={{ fontSize: '1.875rem', fontWeight: 700, color: '#242424' }}>Latest News</h2>
              ...
              {news.map((article) => (
                <article key={article.id} className="news-card">
                  ...
                  <div style={{ padding: '1.75rem' }}>
                    <span style={{ display: 'inline-block', fontSize: '0.6875rem', fontWeight: 600, letterSpacing: '0.12em', textTransform: 'uppercase', padding: '0.3rem 0.75rem', borderRadius: '9999px', background: 'rgba(201,154,46,0.1)', color: '#8a6a1a', border: '1px solid rgba(201,154,46,0.2)', marginBottom: '1rem' }}>
                      {article.category}
                    </span>
                    <h3 style={{ fontSize: '1.0625rem', fontWeight: 700, color: '#242424', lineHeight: 1.35, marginBottom: '0.625rem' }}>{article.title}</h3>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', flexWrap: 'wrap', gap: '1rem', marginBottom: '2.5rem' }}>
              <h2 className="heading-serif" style={{ fontSize: '1.875rem', fontWeight: 700, color: '#242424' }}>Upcoming Events</h2>
                ...
                <div key={event.id} className="card" style={{ padding: '1.75rem 2rem' }}>
                  <div style={{ display: 'flex', flexWrap: 'wrap', alignItems: 'flex-start', justifyContent: 'space-between', gap: '1.25rem' }}>
                    <div style={{ flex: 1, minWidth: '200px' }}>
                      <h3 className="heading-serif" style={{ fontSize: '1.25rem', fontWeight: 700, color: '#242424', marginBottom: '0.875rem' }}>{event.title}</h3>
