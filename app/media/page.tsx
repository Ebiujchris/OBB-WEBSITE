    ...
    <main>
      ...
      <section className="section-space" style={{ background: '#F2ECD8' }}>
        <div className="container-site">
            ...
            {mediaTypes.map((m) => (
              <Link key={m.href} href={m.href} style={{ textDecoration: 'none' }}>
                <div className="card" style={{ padding: '2.25rem', textAlign: 'center' }}>
                  ...
                  <h3 className="heading-serif" style={{ fontSize: '1.375rem', fontWeight: 700, color: '#1A1A1A', marginBottom: '0.5rem' }}>{m.title}</h3>
          ...
          <div style={{ background: '#1E4D38', borderRadius: '1.25rem', padding: '3.5rem', textAlign: 'center' }}>
