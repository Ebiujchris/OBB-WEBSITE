        ...
        <div className="container-site">
          ...
          <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2rem', marginBottom: '2rem' }} className="two-col-grid">
            <div className="card" style={{ padding: '2.5rem' }}>
              <h2 className="heading-serif" style={{ fontSize: '1.75rem', fontWeight: 700, color: '#1A1A1A', marginBottom: '1rem' }}>Who we are</h2>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.75rem' }}>
                {['Language preservation', 'Oral history archiving', 'Community unity', 'Cultural education'].map((item) => (
                  <div key={item} style={{
                    ...
                    background: '#F2ECD8', border: '1px solid rgba(0,0,0,0.06)',
                    borderRadius: '0.625rem', padding: '0.75rem 1rem',
                    fontSize: '0.875rem', fontWeight: 500, color: '#333',
                  }}>
                    <span style={{ width: 6, height: 6, borderRadius: '50%', background: '#C4922A', flexShrink: 0 }} />
                    {item}
                  </div>
                ))}
              </div>
            ...
            <div style={{
              background: 'linear-gradient(135deg, #6B1E2E, #1E4D38)',
              ...
              <div style={{ background: '#fff', borderRadius: '1.15rem', padding: '2.25rem', height: '100%' }}>
                ...
                <h2 className="heading-serif" style={{ fontSize: '1.625rem', fontWeight: 700, color: '#1A1A1A', marginBottom: '1rem', lineHeight: 1.25 }}>
                ...
                {[
                  ...
                  <div key={item.title} style={{ background: '#F2ECD8', borderRadius: '0.75rem', padding: '1.125rem', marginBottom: '0.75rem' }}>
                    <p style={{ fontSize: '0.9rem', fontWeight: 600, color: '#1A1A1A', marginBottom: '0.375rem' }}>{item.title}</p>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '1.5rem', marginBottom: '2rem' }}>
            ...
            <div className="card" style={{ padding: '2.25rem' }}>
              <h2 className="heading-serif" style={{ fontSize: '1.5rem', fontWeight: 700, color: '#1A1A1A', marginBottom: '0.875rem' }}>Our Mission</h2>
              <p style={{ fontSize: '0.9375rem', color: '#666', lineHeight: 1.8, marginBottom: '1.5rem' }}>
            ...
            {/* Story */}
            <div className="card" style={{ padding: '2.25rem' }}>
              <h2 className="heading-serif" style={{ fontSize: '1.5rem', fontWeight: 700, color: '#1A1A1A', marginBottom: '0.875rem' }}>Our Story</h2>
              <p style={{ fontSize: '0.9375rem', color: '#666', lineHeight: 1.8, marginBottom: '1.5rem' }}>
              ...
              {[
                ...
                <div key={year} style={{ background: '#F2ECD8', borderRadius: '0.75rem', padding: '1.125rem', marginBottom: '0.75rem' }}>
            ...
            {/* Values */}
            <div className="card" style={{ padding: '2.25rem' }}>
              <h2 className="heading-serif" style={{ fontSize: '1.5rem', fontWeight: 700, color: '#1A1A1A', marginBottom: '1.25rem' }}>Core Values</h2>
          ...
          <div style={{ background: '#fff', border: '1px solid rgba(0,0,0,0.06)', borderRadius: '1.25rem', padding: '2.5rem 3rem' }}>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: '2.5rem', alignItems: 'center' }} className="two-col-grid">
              <div>
                <h2 className="heading-serif" style={{ fontSize: '1.875rem', fontWeight: 700, color: '#1A1A1A', marginBottom: '0.875rem' }}>Why our work matters</h2>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.875rem' }}>
                {['Intergenerational learning', 'Cultural ceremonies', 'Language recordings', 'Community partnerships'].map((item) => (
                  <div key={item} style={{
                    background: '#F2ECD8', border: '1px solid rgba(0,0,0,0.05)',
